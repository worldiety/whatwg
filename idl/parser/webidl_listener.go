...
type WebIDLListener interface {
	...
	// EnterCallbackOrInterface is called when entering the callbackOrInterface production.
	EnterCallbackOrInterface(c *CallbackOrInterfaceContext)
	...
	// EnterPartialInterface is called when entering the partialInterface production.
	EnterPartialInterface(c *PartialInterfaceContext)
	...
	// EnterImplementsStatement is called when entering the implementsStatement production.
	EnterImplementsStatement(c *ImplementsStatementContext)
	...
	// EnterSerializer is called when entering the serializer production.
	EnterSerializer(c *SerializerContext)

	// EnterSerializerRest is called when entering the serializerRest production.
	EnterSerializerRest(c *SerializerRestContext)

	// EnterSerializationPattern is called when entering the serializationPattern production.
	EnterSerializationPattern(c *SerializationPatternContext)

	// EnterSerializationPatternMap is called when entering the serializationPatternMap production.
	EnterSerializationPatternMap(c *SerializationPatternMapContext)

	// EnterSerializationPatternList is called when entering the serializationPatternList production.
	EnterSerializationPatternList(c *SerializationPatternListContext)
	...
	// EnterInherit is called when entering the inherit production.
	EnterInherit(c *InheritContext)
	...
	// EnterOptionalOrRequiredArgument is called when entering the optionalOrRequiredArgument production.
	EnterOptionalOrRequiredArgument(c *OptionalOrRequiredArgumentContext)
	...
	// EnterExtendedAttributeRest is called when entering the extendedAttributeRest production.
	EnterExtendedAttributeRest(c *ExtendedAttributeRestContext)

	// EnterExtendedAttributeInner is called when entering the extendedAttributeInner production.
	EnterExtendedAttributeInner(c *ExtendedAttributeInnerContext)
	...
	// EnterNonAnyType is called when entering the nonAnyType production.
	EnterNonAnyType(c *NonAnyTypeContext)
	...
	// ExitCallbackOrInterface is called when exiting the callbackOrInterface production.
	ExitCallbackOrInterface(c *CallbackOrInterfaceContext)
	...
	// ExitPartialInterface is called when exiting the partialInterface production.
	ExitPartialInterface(c *PartialInterfaceContext)
	...
	// ExitImplementsStatement is called when exiting the implementsStatement production.
	ExitImplementsStatement(c *ImplementsStatementContext)
	...
	// ExitSerializer is called when exiting the serializer production.
	ExitSerializer(c *SerializerContext)

	// ExitSerializerRest is called when exiting the serializerRest production.
	ExitSerializerRest(c *SerializerRestContext)

	// ExitSerializationPattern is called when exiting the serializationPattern production.
	ExitSerializationPattern(c *SerializationPatternContext)

	// ExitSerializationPatternMap is called when exiting the serializationPatternMap production.
	ExitSerializationPatternMap(c *SerializationPatternMapContext)

	// ExitSerializationPatternList is called when exiting the serializationPatternList production.
	ExitSerializationPatternList(c *SerializationPatternListContext)
	...
	// ExitInherit is called when exiting the inherit production.
	ExitInherit(c *InheritContext)
	...
	// ExitOptionalOrRequiredArgument is called when exiting the optionalOrRequiredArgument production.
	ExitOptionalOrRequiredArgument(c *OptionalOrRequiredArgumentContext)
	...
	// ExitExtendedAttributeRest is called when exiting the extendedAttributeRest production.
	ExitExtendedAttributeRest(c *ExtendedAttributeRestContext)

	// ExitExtendedAttributeInner is called when exiting the extendedAttributeInner production.
	ExitExtendedAttributeInner(c *ExtendedAttributeInnerContext)
	...
	// ExitNonAnyType is called when exiting the nonAnyType production.
	ExitNonAnyType(c *NonAnyTypeContext)
